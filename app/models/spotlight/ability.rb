module Spotlight
  ...
  module Ability
    ...
    def initialize(user)
      ...
      can [:update, :import, :export, :destroy, :manage], :all if user.superadmin?

      # exhibit admin
      can [:update, :import, :export, :destroy, :create], Spotlight::Exhibit, id: user.admin_roles.pluck(:resource_id)
