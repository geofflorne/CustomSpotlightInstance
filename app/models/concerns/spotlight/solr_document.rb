module Spotlight
  ...
  module SolrDocument
    ...
    def uploaded_resource?
	  #Rails.logger.warn("solr_document  ccc uploaded_resource AT:"+Time.now.strftime("%m%d %H:%M:%S:%L")+"\nmmmmmm"+self[self.class.resource_type_field].include?('spotlight/resources/uploads').inspect+" "+self[self.class.resource_type_field].include?('spotlight/resources/videouploads').inspect+" "+self[self.class.resource_type_field].inspect+"\nvvvvvvvvvvvvvv\n") 

      self[self.class.resource_type_field].present? &&
      (self[self.class.resource_type_field].include?('spotlight/resources/uploads') ||
	    self[self.class.resource_type_field].include?('spotlight/resources/videouploads') )
    end
